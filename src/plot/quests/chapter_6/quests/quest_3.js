export const quest3 =
    {
        title: "Стратегия функционирования",
        text: `Время планировать стратегию. Ты достаёшь данные, которые раздобыла для тебя Карада, со своей полки. Тебе нужно найти парней, которых стоит опасаться в первую очередь, и постараться застать их врасплох. Иначе вам не выиграть.
        `,
        regexps: [],
