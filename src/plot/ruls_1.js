        ...
        text: [
            ...
            },
            {
                ...
                text: <div><p>В редакторе кода ты можешь писать свой код. Чтобы запустить его, нажми кнопку 'Run code'
                    или комбинацию ctrl+shift+z. Если задание выполнено правильно, разблокируется следующий квест.
    ...
    [
        {
            ...
            text: [
                {
                    title: "Причина использовать На что способен filter",
            ...
            text: [
                {
                    ...
                    text: `Твое приключение продолжается`,
                },
            ]
        },
        {
            title: "Разблокирована вторая глава",
            text: [
                {
                    title: "Это только начало",
                    text: `Твое приключение продолжается`,
